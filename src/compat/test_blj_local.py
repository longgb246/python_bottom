...
# docker = "xxxvl start -i bdp-docker.xxx.com:5000/wise_mart_cmo_ipc_hecate -o='--net=host' -- python /home/cmo_ipc/zhanchangfei/KPI.py {0} {1} {2} {3} {4}".format(filepath, outpath, costpath, skucate, grossprofit)
# os.system(docker)
...
t_mirror = 'bdp-docker.xxx.com:5000/wise_mart_bca:latest'  # 镜像

docker = "xxxvl start -m {mount} -i {mirror} -o='--net=host' " \
